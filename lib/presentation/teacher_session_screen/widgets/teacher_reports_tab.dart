  ...
  Future<void> _loadReport() async {
    ...
    try {
      ...
      if (_selectedSubjectId != null) {
        filtered = filtered
            .where((r) => r['sessions']?['subject_id'] == _selectedSubjectId)
            .toList();
      } else {
        filtered = filtered
            .where((r) => allowedSubjectIds.contains(r['sessions']?['subject_id']))
            .toList();
      }
      ...
      if (_reportStartDate != null || _reportEndDate != null) {
        filtered = filtered.where((r) {
          ...
          if (_reportStartDate != null && ts.isBefore(_reportStartDate!)) return false;
          if (_reportEndDate != null) {
            final end = _reportEndDate!.add(const Duration(days: 1));
